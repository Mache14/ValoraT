...
export type TribeScoreKey = 'tmt_b' | 'pvt_rt' | 'balance_oa' | 'balance_oc' | 'sts30' | 'armcurl' | 'tug' | 'balltoss'
...
export const MOCK_TRIBE_MEMBERS: TribeMember[] = [
  { name: 'Ana',    avatar: '👩',    scores: { tmt_b: 72,  pvt_rt: 245, balance_oa: 38.5, balance_oc: 8.2,  sts30: 22, armcurl: 24, tug: 9.5,  balltoss: 26 } },
  { name: 'Carlos', avatar: '👨',    scores: { tmt_b: 95,  pvt_rt: 310, balance_oa: 25.0, balance_oc: 5.1,  sts30: 18, armcurl: 19, tug: 12.3, balltoss: 18 } },
  { name: 'María',  avatar: '👩‍🦰', scores: { tmt_b: 65,  pvt_rt: 220, balance_oa: 42.0, balance_oc: 12.0, sts30: 25, armcurl: 27, tug: 8.2,  balltoss: 30 } },
  { name: 'Pedro',  avatar: '👴',    scores: { tmt_b: 110, pvt_rt: 380, balance_oa: 15.0, balance_oc: 3.5,  sts30: 14, armcurl: 15, tug: 14.8, balltoss: 13 } },
  { name: 'Laura',  avatar: '👩‍🔬', scores: { tmt_b: 80,  pvt_rt: 260, balance_oa: 35.0, balance_oc: 9.0,  sts30: 20, armcurl: 22, tug: 10.1, balltoss: 22 } },
]
